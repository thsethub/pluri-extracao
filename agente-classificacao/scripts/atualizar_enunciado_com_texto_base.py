...
def atualizar_questao_com_texto_base(questao_rd_id: int):
    ...
    try:
        ...
        enunciado_novo = integrar_texto_base(texto_base_processado, questao.enunciado_original)
        ...
        print(f"   Diferença: +{len(enunciado_novo) - len(questao.enunciado_atual)} caracteres")
